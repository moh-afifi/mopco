...
class RestVacationDetails extends StatefulWidget {
  RestVacationDetails({this.code});
  final String code;
  @override
  _RestVacationDetailsState createState() => _RestVacationDetailsState();
}

class _RestVacationDetailsState extends State<RestVacationDetails> {
