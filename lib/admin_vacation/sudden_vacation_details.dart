...
class SuddenVacationDetails extends StatefulWidget {
  SuddenVacationDetails({this.code});
  final String code;
  @override
  _SuddenVacationDetailsState createState() => _SuddenVacationDetailsState();
}

class _SuddenVacationDetailsState extends State<SuddenVacationDetails> {
