...
class ConfirmHoursDialog extends StatefulWidget {
  ConfirmHoursDialog(
      {this.from,
        this.to,
        this.numOfDays,
  ...
  @override
  _ConfirmHoursDialogState createState() => _ConfirmHoursDialogState();
}

class _ConfirmHoursDialogState extends State<ConfirmHoursDialog> {
          ...
          FlatButton(
            ...
            onPressed: () async {
              ...
              if ((connectivityResult == ConnectivityResult.mobile) ||
                ...
                DocumentReference reference1 = _fireStore.document("ساعات/${widget.docId}");
                Map<String, dynamic> myData1 = {
                  'المستنفذ من الساعات': addedVacation,
                };
                ...
                DocumentReference reference2 = _fireStore.document("ساعات/${widget.docId}");
                Map<String, dynamic> myData2 = {
                  'المتبقي': restVacation,
                };
                await reference2.updateData(myData2);
                //-----------------------------------------------------------
                await  _fireStore.collection('تفاصيل الساعات').add({
                  'code': widget.code,
