          ...
          FlatButton(
            ...
            onPressed: () async {
              ...
              if ((connectivityResult == ConnectivityResult.mobile) ||
                ...
                DocumentReference reference1 = _fireStore.document("عارضة/${widget.docId}");
                Map<String, dynamic> myData1 = {
                  'المستنفذ': addedVacation,
                };
                ...
                DocumentReference reference2 = _fireStore.document("عارضة/${widget.docId}");
                Map<String, dynamic> myData2 = {
                  'باقي العارضة': restVacation,
                };
                await reference2.updateData(myData2);
                //-----------------------------------------------------------
                await  _fireStore.collection('تفاصيل العارضة').add({
                  'code': widget.code,
